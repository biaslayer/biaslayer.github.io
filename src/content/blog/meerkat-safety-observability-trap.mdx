...
This week the hype cycle found a new favorite safety paper: **[Detecting Safety Violations Across Many Agent Traces](https://arxiv.org/pdf/2604.11806).** The framework, called **Meerkat**, argues that many of the worst failures in agent systems do not show up in a single run. They emerge only when you analyze large collections of traces together.
